...
module ElasticGraph
  module Warehouse
    module SchemaDefinition
      # Extends {ElasticGraph::SchemaDefinition::SchemaElements::ObjectType} to add warehouse table definition support.
      module ObjectTypeExtension
        attr_reader :warehouse_table_def

        # Defines a warehouse table for this object type
        #
        ...
        # Converts this object type to a warehouse field type
        #
